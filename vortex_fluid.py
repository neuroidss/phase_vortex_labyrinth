...
class FluidSolver:
    ...
    def advect(self, field, u, v, dt):
        ...
        # Заменяем Torus Topology на жесткое ограничение координат во избежание циклического переноса
    ...
    def project(self, u, v, wall_density, target_div=None):
        ...
        # Избегаем круговой фильтрации, переходя на режим репликации крайних значений
